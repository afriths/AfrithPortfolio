...
export default function Education() {
  ...
  return (
    <section id="education" className="py-16 md:py-24 bg-white dark:bg-gray-900 relative transition-colors duration-300">
          ...
          <div className="space-y-10">
            {education.map((edu, index) => (
              ...
              >
                ...
                <div className="absolute left-4 md:left-1/2 transform -translate-x-1/2 w-6 h-6 rounded-full bg-cyan-500 border-4 border-slate-100 dark:border-gray-900 shadow-lg shadow-cyan-500/30 z-10 transition-all duration-900 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] group-hover:scale-125 group-hover:shadow-cyan-500/50 group-hover:shadow-xl "></div>
                ...
                <div className={`
                  bg-gradient-to-br from-white to-slate-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8 
                  shadow-2xl border border-slate-200 dark:border-gray-700/50 transition-all duration-400 ease-[cubic-bezier(0.25,0.8,0.25,1)] 
                  group-hover:-translate-y-2 group-hover:shadow-3xl group-hover:border-slate-300 dark:group-hover:border-cyan-500/30 dark:group-hover:shadow-cyan-500/10
                  cursor-pointer
                ...
                `}>
                  ...
                  <p className="text-slate-600 dark:text-gray-400 text-sm mb-4">{edu.duration}</p>
                  <div className="flex items-center gap-2">
                    {/* <Award className="w-4 h-4 text-emerald-400 flex-shrink-0" /> */}
                    <span className="text-base font-semibold text-slate-900 dark:text-white bg-emerald-100 dark:bg-emerald-900/30 px-3 py-1 rounded-full border border-emerald-300 dark:border-emerald-500/20">
                      {edu.performance}
                    </span>
                  </div>
                </div>
